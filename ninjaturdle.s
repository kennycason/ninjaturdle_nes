...
; was_jumping = 0;
;
L0094:	sta     _was_jumping
;
; if (L_R_switch && (scroll_x & 0xff) < 4) {
;
L0045:	lda     _L_R_switch
	beq     L004B
	lda     _scroll_x
	cmp     #$04
	bcs     L004B
...
;
	jsr     _bg_collision_sub_any_ground
;
; }
;
	jmp     incsp5
